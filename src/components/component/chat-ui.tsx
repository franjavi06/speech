  ...
  return (
    <div className="flex flex-col h-screen">
        ...
        <div className="grid gap-4">
          ...
          <div className="flex items-start gap-4 justify-end">
            <div className="grid gap-1.5 bg-primary text-primary-foreground p-4 rounded-lg max-w-[75%]">
              <p className="text-sm">Pretty good, just working on a new project. You?</p>
          ...
          <div className="flex items-start gap-4 justify-end">
            <div className="grid gap-1.5 bg-primary text-primary-foreground p-4 rounded-lg max-w-[75%]">
              <p className="text-sm">
                It's a new chat app with speech-to-text and text-to-speech capabilities. We're trying to make it really
      ...
      <div className="bg-background px-6 py-4 flex items-center gap-4">
        ...
        <Button type="submit" className="bg-primary text-primary-foreground px-4 py-2 rounded-full">
          Send
        </Button>
      </div>
    </div>
